#include "tracker.h"
#include "Interaction.h"   //人机协作

#define BOUNDARY 30   //人机协作，处理重叠时图片内部大小

#define IM_NUM 150 //处理图片的张数
...
void tracker::form_tracklets()
{
	...
	string s1 = "D:\\MOT\\CSCW_Project\\video_dataset\\sperm_";
	string num;
	string s2 = ".jpg";
	//trace_gray = read_trans("D:\\Mot VS2013 project\\Mot test1\\video_dataset\\sperm_0000.jpg");
	trace_gray = read_trans("D:\\MOT\\CSCW_Project\\video_dataset\\sperm_0000.jpg");
	...
	for (int i = 1; i < IM_NUM; i++)    //分割所有图片
	{
		...
		//        判断前后两帧目标的重叠和碰撞 
		//*********************************************************//
		//cout << "###tracker aft size:" << aft_minellipse.size() << endl;
		aft_minellipse = InterAlgo.Solve(pre_minellipse, aft_minellipse, s1);
		...
		s1 = "D:\\MOT\\CSCW_Project\\video_dataset\\sperm_";
	}
